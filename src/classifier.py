...
from typing import (cast, Optional, Callable, Any, Type, Mapping, overload, Iterable, Union, Iterator,
)
...
class User:
    def __init__(self, username:str, email:str, real_name:str, role:Role, password:Optional[str] = None,
    ) ->None:
...
class NotAuthorized(Exception):
    ...
    def __init__(self, message:str, status_code:Optional[int] = None, payload:Optional[dict[str, str]] = None,
    ) -> None:
